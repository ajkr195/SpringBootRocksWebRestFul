...
function show(data) {
    ...
    <td><a class="btn btn-sm btn-success mx-1" href="/api/activateUser/${appuser.id}" onClick="activateUser(this);event.preventDefault();"><i class="fas fa-heartbeat"></i></a>
    <a class="btn btn-sm btn-secondary mx-1" href="/api/deActivateUser/${appuser.id}" onClick="deActivateUser(this);event.preventDefault();"><i class="fas fa-skull-crossbones"></i></a>
    <a class="btn btn-sm btn-danger mx-1" href="/api/deleteUser/${appuser.id}" onClick="deleteUser(this);event.preventDefault();"><i class="far fa-trash-alt"></i></a>
	<a class="btn btn-sm btn-info mx-1" data-bs-toggle="modal" data-bs-target="#exampleModal" id="viewdetailsbtn" onclick="displayUsers(${appuser.id});"><i class="far fa-times-circle"></i></a>
	<a class="btn btn-sm btn-warning" onclick="onEdit(this)"><i class="fas fa-user-edit"></i></a>
    </td>               
</tr></tbody>`;
...
async function insertNewRecord(formData) {
	...
	if (response.ok) {
		...
		cell9.innerHTML = `<a class="btn btn-sm btn-success mx-1" href="/api/activateUser/${data.id}" onClick="activateUser(this);event.preventDefault();"><i class="fas fa-heartbeat"></i></a>
